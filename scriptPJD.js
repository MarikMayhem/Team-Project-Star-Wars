...
function renderCharacterData(character) {
    ...
    headNameDiv.text(character['name']);
    ...
    // section1Div.append(infoPicDiv);
    // section1Div.append(infoTextDiv);
    row1Div
        .append(infoPicDiv)
        .append(infoTextDiv);
    section1Div.append(row1Div);
...
function renderSpaceshipData(spaceship) {
    ...
    let headNameDiv = $('<div>');
    headNameDiv.addClass('head-name col-lg-8 offset-lg-2');
    headNameDiv.text(spaceship['name']);
    containter.append(headNameDiv);
    ...
    let infoPicDiv = $('<div>');
    infoPicDiv.addClass('info-pic col-lg-6 col-md-12');
    let image = $('<img src="images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-info.png">');
    infoPicDiv.append(image);
    let infoTextDiv = $('<div>');
    infoTextDiv.addClass('info-text col-lg-6 col-md-12');
    let pDiv = $('<p>');
...
//section 2 info 1
    ...
    // let section3Row = $('<div>');
    // section3Row.addClass('row');
    // let picDiv1 = $('<div class="gall-pic col-lg-6 col-md-12"><img src="images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-gallery-1.jpg"> </div>');
    // let picDiv2 = $('<div class="gall-pic col-lg-6 col-md-12"><img src="images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-gallery-2.jpg"> </div>');
    // let picDiv3 = $('<div class="gall-pic col-lg-6 col-md-12"><img src="images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-gallery-3.jpg"> </div>');
    // let picDiv4 = $('<div class="gall-pic col-lg-6 col-md-12"><img src="images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-gallery-4.jpg"> </div>');
    // section3Row
    //     .append(picDiv1)
    //     .append(picDiv2)
    //     .append(picDiv3)
    ...
    $('main')
        .css('background', 'url("images/' + spaceship['name'].toLowerCase() + '/' + spaceship['name'].toLowerCase() + '-photo.jpg")top center no-repeat');
    $('body')
        .css('background','none')
        .css('background-color','black');
...
function renderCharacters(content){
    ...
    $('.container-content')
        .append($('<h1 id="heading-data">PLANETS</h1>'))
...
function renderCharacter(character){
    ...
    let img = $('<img src="renderAll_images/planets/' + name + '.png" alt="">');
